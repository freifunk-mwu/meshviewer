define(["chroma-js", "virtual-dom", "numeral-intl", "filters/genericnode", "vercomp" ],
  ...
  return function (config, filterManager) {
    ...
    self.setData = function (data) {
      ...
      fillTable("B.A.T.M.A.N. Gateway", gwTable, gwDict.sort(function (a, b) { return b[1] - a[1] }))
      fillTable("VPN-Peer", vpnTable, vpnDict.sort(function (a, b) { return b[1] - a[1] }))
    }
    ...
    self.render = function (el) {
      ...
      h2 = document.createElement("h2")
      h2.textContent = "B.A.T.M.A.N. Gateway"
      el.appendChild(h2)
